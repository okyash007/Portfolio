        ...
        <SimpleGrid>
          <Section>
            <WorkGridItem
              ...
              thumbnail={thumbComs}
            >
              Basicaly its notion but its based on serverless backend
              (cloudflare worker)
          ...
          <Section>
            ...
            >
              ...
              <Wrap>
                <Link href="https://github.com/okyash007/pro-manage">code</Link>
          ...
          <Section>
            ...
            >
              ...
              <Wrap>
                ...
                <Link href="https://chess-game-yash-68g3.onrender.com">
                  live
                </Link>
              </Wrap>
            </WorkGridItem>
          ...
          <Section>
            <WorkGridItem title="Gitsta" thumbnail={thumbFakeFace}>
              A Social Media web aap where you can create posts and chat in
              realtime.
              <Wrap style={{ marginTop: '0.5rem' }}>
                <Tag>React.js</Tag>
              ...
              <Wrap>
                <Link href="https://github.com/okyash007/social-app">code</Link>
          ...
          <Section delay={0.1}>
            <WorkGridItem
              ...
              title="tic-tac-toe"
            >
              A tic tac toe game which has 1v1 feature, you can also play with
              pc, you can have a look at winning logic{' '}
              <Link
              ...
              <Wrap>
                <Link href="https://github.com/okyash007/tic-tac-toe">
                  code
                </Link>
                <Link href="https://tic-tac-toe-okyash007.vercel.app/">
                  live
                </Link>
              </Wrap>
            </WorkGridItem>
